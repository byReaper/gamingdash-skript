...
function krankenhaus_gui()
	...
	Krankenhaus_Label[2] = guiCreateLabel(18, 39, 274, 19, "Du bist im Krankenhaus geladen und wirst wieder zusammengeflickt.", false, Krankenhausgui)
	...
	Krankenhaus_Label[3] = guiCreateLabel(20, 68, 245, 25, "Bitte warte einen Moment, bis du das Krankenhaus wieder verlassen darfst.", false, Krankenhausgui)
